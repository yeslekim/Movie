...
<body class="bg-gradient-primary">
	<!-- <form action="loginUser.do" method="post"> <!-- controller로 이동  --> 
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="loginUser.do" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="id" aria-describedby="emailHelp" placeholder="ID">
                    </div>
                    <div class="form-group">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="addUser.do">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
